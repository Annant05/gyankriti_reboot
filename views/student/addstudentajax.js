...
function isAnyInputFieldEmpty() {
    let isEmpty = false;
    const formData = getFormInputsData();
    Object.keys(formData).forEach(function (key) {
        // console.log(key + ": " + formData[key]);
        if (formData[key] === "") isEmpty = true;
    });

    if (formData.student_gender === undefined) isEmpty = true;
    console.log("isAnyFieldEmpty() return value :  " + !isEmpty);
    return !isEmpty;
}
