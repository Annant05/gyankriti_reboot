...
router.post('/new_admission', function (req, res) {
    ...
    try {
        ...
        console.log("is Data Saved to the dynamodb 'student' table:  " + (dynamoStudent.newAdmission(req.body.new_admission_data)));
